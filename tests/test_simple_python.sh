...
cargo run -p toggle-cli -- --section debug --force on tests/fixtures/simple_python.py
...
cargo run -p toggle-cli -- --section debug --force off tests/fixtures/simple_python.py
...
cargo run -p toggle-cli -- --section feature --force on tests/fixtures/simple_python.py
...
cargo run -p toggle-cli -- --line 3:6 tests/fixtures/simple_python.py

# Test 5: Toggle all sections at once
echo "Test 5: Toggle all sections at once"
cargo run -p toggle-cli -- --section debug --section feature tests/fixtures/simple_python.py
